...
import widgets from './widgets/widgetList';
...
const merchantConfirmation = getURLParameter('txnState');
...
// find elements by class and render widget
...
function setLanguage() {
  AlphaPoint.getUserConfig.subscribe((data) => {
    ...
    if (configs.language) {
      ...
      setLanguageDirection(configs.language);
...
function init() {
  ...
  // Eliminates race condition from
  if (document.APAPI.IsConnected) {
    orderbook.init();
  }
