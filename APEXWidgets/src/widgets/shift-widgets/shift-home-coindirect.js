...
AP Bugs:
AS-1530: move the AlphaPoint.translation('HOME_DIRECT.STEP2') on line 178 to the above code and update the translation API call on 178 to STEP2_CONTENT in home-coindirect.js
AS-1531:  move the AlphaPoint.translation('HOME_DIRECT.STEP3') on line 207 to the above code and update the translation API call on 192 to STEP3_CONTENT in home-coindirect.js
AS-1532: fix the condition all call data.result in home-coindirect.js
...
class ShiftHomeCoindirect extends React.Component {
  constructor() {
    super();
    this.defaultStepLink = 'my-accounts.html';
    ...
    this.state = {
      ...
      verifyLevel: 0,
      levelIncreaseStatus: '',
      step2link: this.defaultStepLink,
      step3link: this.defaultStepLink,
    };
  }

  prepareStepLinks = () => {
    if (AlphaPoint.config.home && AlphaPoint.config.home.gettingStarted) {
      const gettingStarted = AlphaPoint.config.home.gettingStarted;
      this.setState({ 
        step2link: gettingStarted.step2link || this.defaultStepLink,
        step3link: gettingStarted.step3link || this.defaultStepLink
      });
    }
  }
  ...
  componentDidMount() {
    ...
    this.userConfiguration = AlphaPoint.getUserConfig.subscribe(data => {
      ...
      this.accountInfo = AlphaPoint.accountInfo.subscribe(accountData => {
        ...
        this.setState({
          ...
          showHomeModal: showBool,
        });


        this.tradeHistory = AlphaPoint.accountTrades.subscribe(data => {
          // console.log("account trades value: " + AlphaPoint.accountTrades.value);
    ...
    AlphaPoint.getAccountTransactions();
  }

  shouldLaunchKYC = () => {
    if (this.state.verifyLevel <= AlphaPoint.config.clickableStep1Level) {
        ...
        {this.state.showHome1 &&
          <span>
            ...
            <div className="services-list">
              ...
              <div className="service-item">
                <a href={this.state.step2link}>
                  <h3 className="service-title">{AlphaPoint.translation('HOME_DIRECT.STEP2') || 'Step 2 - Add Funds'} </h3>
                  <div className="service-thumb">
                    {
                  ...
                  <div className="service-content">
                    <p>
                      {
                        AlphaPoint.translation('HOME_DIRECT.STEP2_CONTENT') ||
                  ...
                  <div className={(this.state.madeDeposits) ? 'service-checked active' : 'service-checked'}>
                    <a href={this.state.step2link}>{check}</a>
                  </div>
                </a>
              </div>

              <div className="service-item">
                <a href={this.state.step3link}>
                  <h3 className="service-title">{AlphaPoint.translation('HOME_DIRECT.STEP3') || 'Step 3 - Buy, Sell, Trade'}</h3>
                  ...
                  <div className="service-content">
                    <p>
                      {
                        AlphaPoint.translation('HOME_DIRECT.STEP3_CONTENT') || `Buying, selling, and trading cryptocurrency in ${AlphaPoint.config.siteTitle} is extremely simple, and after just a few steps you will complete each transaction quickly and securely. Just click the "Buy/Sell" or "Send/Request" buttons on the left menu and you will be well on your way. Clarity and simplicity are our main goals, but if you have any questions, just let us know and we will assist you.`
                      }
                    </p>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-sm-4 text-center">
                        <div className="img-content">
                          ...
                          <div className="img-thumb">{AlphaPoint.translation('HOME_DIRECT.STEP1') || 'Step 1 - Verify Your Account'}</div>
                        </div>
                      </div>
                      <div className="col-sm-4 text-center">
                        <div className="img-content">
                          ...
                          <div className="img-thumb">{AlphaPoint.translation('HOME_DIRECT.STEP2') || 'Step 2 - Add Funds'}</div>
                        </div>
                      </div>
                      <div className="col-sm-4 text-center">
                        <div className="img-content">
                          ...
                          <div className="img-thumb">{AlphaPoint.translation('HOME_DIRECT.STEP3') || 'Step 3 - Trade'}</div>
                        </div>
                      </div>
                    </div>
...
export default ShiftHomeCoindirect;
